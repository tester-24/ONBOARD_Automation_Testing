...
it('Onboard_Jainam', () => {
    ...
    //Click on Reason
    cy.get('[data-kendo-grid-item-index="3"] > [aria-colindex="2"] > [placement="bottom"] > .fa').click()
    cy.wait(3000)
    ...
    //Edit the data
    cy.get('[data-kendo-grid-item-index="6"] > [aria-colindex="2"] > :nth-child(1) > .fa').click()
    cy.wait(2000)
